...
All states, insurance companies, and junk and salvage yards are required by federal law to regularly report information to NMVTIS. However, NMVTIS does not contain information on all motor VINs in the United States because some states are not yet providing their vehicle data to the system. Currently, the data provided to NMVTIS by states is provided in a variety of time frames; while some states report and update NMVTIS data in “real-time” (as title transactions occur), other states send updates less frequently, such as once every 24 hours or within a period of days.
...
• Information on automobiles, buses, trucks, motorcycles, recreational VINs, motor homes, and truck tractors. NMVTIS may not currently include commercial VINs if those VINs are not included in a state’s primary database for title records (in some states, those VINs are managed by a separate state agency), although these records may be added at a later time.

• Information on “brands” applied to VINs provided by participating state motor vehicle titling agencies. Brand types and definitions vary by state, but may provide useful information about the condition or prior use of the vehicle.
...
Consumers are advised to visit vehiclehistory.bja.ojp.gov for details on how to interpret the information in the system and understand the meaning of various labels applied to VINs by the participating state motor vehicle titling agencies.`;
