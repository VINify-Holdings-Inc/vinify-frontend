...
export class NavPdfService {
  ...
  generatePDF(
    ...
    (doc as any).autoTable({
      ...
      head: [tableColumn],
      body: tableRows,
      headStyles: { fillColor: [207, 75, 95], fontSize: 8 },
    ...
    y = (doc as any).lastAutoTable.finalY + 10;
      ...
      doc.rect(15, y, 180, 10, 'F');
      doc.setTextColor(255, 255, 255);
      doc.text('Warning - Brand total loss events have been reported.', 20, y + 7);
      doc.setTextColor(0, 0, 0);
      y += 15;
...
y = (doc as any).lastAutoTable.finalY + 10;
    ...
    doc.rect(15, y, 180, 10, 'F');
    doc.setTextColor(255, 255, 255);
    doc.text('Warning - Junk, salvage or insurance total loss events have been reported.', 20, y + 7);
    doc.setTextColor(0, 0, 0);
    y += 15;
